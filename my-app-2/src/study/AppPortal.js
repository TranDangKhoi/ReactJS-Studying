    ...
    <div className='flex items-center justify-center h-screen gap-x-5'>
      ...
      >
        <div className='p-10 bg-white rounded-lg w-full max-w-[320px]'>
          ...
          <br />
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam vero iste eaque eos repellendus corporis ipsa
          quas alias aperiam dolore, consequatur quibusdam, maxime ipsum dolorem expedita? Repudiandae nihil
          perspiciatis saepe.
        </div>
      </ModalBase>
      <ModalAdvanced
      ...
      >
        ...
        <button className='w-full p-4 text-base font-medium text-white bg-blue-500 rounded-lg'>Sign In</button>
      </ModalAdvanced>
      <TooltipAdvanced
        overlay={false}
        tooltipText={'Tooltip'}
